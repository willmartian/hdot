...
type GlobalHTMLAttributes<TagName extends keyof HTMLElements> = {
  ...
  autofocus: (value: string) => HTMLElements[TagName];
  ...
  is: (value: string) => HTMLElements[TagName];
  ...
  itemscope: (value: string) => HTMLElements[TagName];
  ...
  tabindex: (value: string) => HTMLElements[TagName];
...
type audioElement = {
  ...
  autoplay: (value: string) => HTMLElements["audio"];
  /** If this attribute is present, the browser will offer controls to allow the user to control audio playback, including volume, seeking, and pause/resume playback. */
  controls: (value: string) => HTMLElements["audio"];
  ...
  loop: (value: string) => HTMLElements["audio"];
  /** A Boolean attribute that indicates whether the audio will be initially silenced. Its default value is false. */
  muted: (value: string) => HTMLElements["audio"];
...
type buttonElement = {
  ...
  disabled: (value: string) => HTMLElements["button"];
  ...
  formnovalidate: (value: string) => HTMLElements["button"];
...
type canvasElement = {
  height: (value: string) => HTMLElements["canvas"];
  ...
  width: (value: string) => HTMLElements["canvas"];
...
type detailsElement = {
  open: (value: string) => HTMLElements["details"];
...
type dialogElement = {
  open: (value: string) => HTMLElements["dialog"];
...
type embedElement = {
  ...
  height: (value: string) => HTMLElements["embed"];
  ...
  width: (value: string) => HTMLElements["embed"];
...
type fieldsetElement = {
  ...
  disabled: (value: string) => HTMLElements["fieldset"];
...
type formElement = {
  ...
  novalidate: (value: string) => HTMLElements["form"];
...
type iframeElement = {
  ...
  allowfullscreen: (value: string) => HTMLElements["iframe"];
  ...
  height: (value: string) => HTMLElements["iframe"];
  ...
  width: (value: string) => HTMLElements["iframe"];
...
type imgElement = {
  ...
  height: (value: string) => HTMLElements["img"];
  ...
  ismap: (value: string) => HTMLElements["img"];
  ...
  width: (value: string) => HTMLElements["img"];
...
type inputElement = {
  ...
  checked: (value: string) => HTMLElements["input"];
  ...
  disabled: (value: string) => HTMLElements["input"];
  ...
  /** Valid for the image and submit input types only. See the submit input type for more information. */
  formnovalidate: (value: string) => HTMLElements["input"];
  /** Valid for the image and submit input types only. See the submit input type for more information. */
  formtarget: (value: string) => HTMLElements["input"];
  height: (value: string) => HTMLElements["input"];
  ...
  maxlength: (value: string) => HTMLElements["input"];
  min: (value: string) => HTMLElements["input"];
  minlength: (value: string) => HTMLElements["input"];
  ...
  multiple: (value: string) => HTMLElements["input"];
  ...
  readonly: (value: string) => HTMLElements["input"];
  required: (value: string) => HTMLElements["input"];
  ...
  width: (value: string) => HTMLElements["input"];
...
type linkElement = {
  ...
  disabled: (value: string) => HTMLElements["link"];
...
type meterElement = {
  ...
  high: (value: string) => HTMLElements["meter"];
  low: (value: string) => HTMLElements["meter"];
  max: (value: string) => HTMLElements["meter"];
  min: (value: string) => HTMLElements["meter"];
  optimum: (value: string) => HTMLElements["meter"];
  role: (value: string) => HTMLElements["meter"];
  value: (value: string) => HTMLElements["meter"];
...
type objectElement = {
  ...
  height: (value: string) => HTMLElements["object"];
  ...
  width: (value: string) => HTMLElements["object"];
} & GlobalAriaAttributes<"object"> &
  GlobalHTMLAttributes<"object">;

type olElement = {
  reversed: (value: string) => HTMLElements["ol"];
...
type optgroupElement = {
  ...
  disabled: (value: string) => HTMLElements["optgroup"];
...
type optionElement = {
  ...
  disabled: (value: string) => HTMLElements["option"];
  label: (value: string) => HTMLElements["option"];
  role: (value: string) => HTMLElements["option"];
  selected: (value: string) => HTMLElements["option"];
...
type progressElement = {
  max: (value: string) => HTMLElements["progress"];
  role: (value: string) => HTMLElements["progress"];
  value: (value: string) => HTMLElements["progress"];
...
type scriptElement = {
  async: (value: string) => HTMLElements["script"];
  ...
  defer: (value: string) => HTMLElements["script"];
  ...
  nomodule: (value: string) => HTMLElements["script"];
...
type selectElement = {
  ...
  disabled: (value: string) => HTMLElements["select"];
  ...
  multiple: (value: string) => HTMLElements["select"];
  /** This attribute is used to specify the name of the control. */
  name: (value: string) => HTMLElements["select"];
  /** A Boolean attribute indicating that an option with a non-empty string value must be selected. */
  required: (value: string) => HTMLElements["select"];
...
type sourceElement = {
  height: (value: string) => HTMLElements["source"];
  ...
  width: (value: string) => HTMLElements["source"];
...
type textareaElement = {
  ...
  disabled: (value: string) => HTMLElements["textarea"];
  ...
  maxlength: (value: string) => HTMLElements["textarea"];
  /** The minimum number of characters (UTF-16 code units) required that the user should enter. */
  minlength: (value: string) => HTMLElements["textarea"];
  ...
  readonly: (value: string) => HTMLElements["textarea"];
  /** This attribute specifies that the user must fill in a value before submitting a form. */
  required: (value: string) => HTMLElements["textarea"];
...
type trackElement = {
  default: (value: string) => HTMLElements["track"];
  kind: (
...
type videoElement = {
  ...
  autoplay: (value: string) => HTMLElements["video"];
  /** If this attribute is present, the browser will offer controls to allow the user to control video playback, including volume, seeking, and pause/resume playback. */
  controls: (value: string) => HTMLElements["video"];
  ...
  height: (value: string) => HTMLElements["video"];
  /** A Boolean attribute; if specified, the browser will automatically seek back to the start upon reaching the end of the video. */
  loop: (value: string) => HTMLElements["video"];
  ...
  muted: (value: string) => HTMLElements["video"];
  playsinline: (value: string) => HTMLElements["video"];
  ...
  width: (value: string) => HTMLElements["video"];
