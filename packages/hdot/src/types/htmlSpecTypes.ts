...
type aElement = {
  accesskey: (
    val: DomTypeMap[`{"token":"OneCodePointChar","ordered":true,"unique":true,"number":"zeroOrMore","separator":"space"}`]
  ) => HTMLElement<"a">;
  autocapitalize: (
    val: "off" | "on" | "none" | "sentences" | "words" | "characters"
  ) => HTMLElement<"a">;
  ...
  enterkeyhint: (
    val: "enter" | "done" | "go" | "next" | "previous" | "search" | "send"
  ) => HTMLElement<"a">;
  ...
  itemprop: (
    val: DomTypeMap[`{"token":"ItemProp","ordered":false,"unique":true,"separator":"space"}`]
  ) => HTMLElement<"a">;
  itemref: (
    val: DomTypeMap[`{"token":"DOMID","separator":"space"}`]
  ) => HTMLElement<"a">;
  itemscope: (val: DomTypeMap["Boolean"]) => HTMLElement<"a">;
  itemtype: (
    val: DomTypeMap[`{"token":"AbsoluteURL","ordered":false,"unique":true,"separator":"space"}`]
  ) => HTMLElement<"a">;
  ...
  ping: (
    val: DomTypeMap[`{"token":"HTTPSchemaURL","separator":"space"}`]
  ) => HTMLElement<"a">;
  ...
  rel: (
    val: DomTypeMap[`{"token":{"enum":["alternate","author","bookmark","external","help","license","next","nofollow","noopener","noreferrer","opener","prev","search","tag"]},"unique":true,"separator":"space"}`]
  ) => HTMLElement<"a">;
  ...
  role: (
    val: DomTypeMap[`{"token":"NoEmptyAny","separator":"space"}`]
  ) => HTMLElement<"a">;
...
type areaElement = {
  ...
  coords: (
    val: DomTypeMap[`{"token":"Number","disallowToSurroundBySpaces":true,"separator":"comma"}`]
  ) => HTMLElement<"area">;
  ...
  target: (
    val: DomTypeMap["BrowsingContextNameOrKeyword"]
  ) => HTMLElement<"area">;
...
type blockquoteElement = {
  ...
  style: (
    val: DomTypeMap["<css-declaration-list>"]
  ) => HTMLElement<"blockquote">;
...
type colElement = {
  ...
  span: (
    val: DomTypeMap[`{"type":"integer","gt":0,"lte":1000,"clampable":true}`]
  ) => HTMLElement<"col">;
...
type formElement = {
  ...
  rel: (
    val: DomTypeMap[`{"token":{"enum":["external","help","license","next","nofollow","noopener","noreferrer","opener","prev","search"]},"unique":true,"separator":"space"}`]
  ) => HTMLElement<"form">;
  role: (
    val: DomTypeMap[`{"token":"NoEmptyAny","separator":"space"}`]
  ) => HTMLElement<"form">;
...
type iframeElement = {
  ...
  allow: (
    val: DomTypeMap["SerializedPermissionsPolicy"]
  ) => HTMLElement<"iframe">;
...
type inputElement = {
  accept: (
    val: DomTypeMap[`{"token":"Accept","caseInsensitive":true,"unique":true,"separator":"comma"}`]
  ) => HTMLElement<"input">;
  accesskey: (
    val: DomTypeMap[`{"token":"OneCodePointChar","ordered":true,"unique":true,"number":"zeroOrMore","separator":"space"}`]
  ) => HTMLElement<"input">;
  ...
  step: (
    val: DomTypeMap[`["Number",{"enum":["any"],"caseInsensitive":true}]`]
  ) => HTMLElement<"input">;
...
type linkElement = {
  ...
  rel: (
    val: DomTypeMap[`["Any",{"token":{"enum":["alternate","canonical","author","dns-prefetch","help","icon","manifest","modulepreload","license","next","pingback","preconnect","prefetch","preload","prerender","prev","search","stylesheet"]},"unique":true,"separator":"space"}]`]
  ) => HTMLElement<"link">;
  ...
  sizes: (
    val: DomTypeMap[`{"token":"IconSize","caseInsensitive":true,"ordered":false,"unique":true,"separator":"space"}`]
  ) => HTMLElement<"link">;
...
type scriptElement = {
  ...
  type: (
    val: DomTypeMap[`["MIMEType",{"enum":["module"],"caseInsensitive":true}]`]
  ) => HTMLElement<"script">;
...
type tdElement = {
  ...
  colspan: (
    val: DomTypeMap[`{"type":"integer","gt":0,"lte":1000}`]
  ) => HTMLElement<"td">;
  ...
  headers: (
    val: DomTypeMap[`{"token":"DOMID","ordered":false,"unique":true,"separator":"space"}`]
  ) => HTMLElement<"td">;
  ...
  rowspan: (
    val: DomTypeMap[`{"type":"integer","gt":0,"lte":65534}`]
  ) => HTMLElement<"td">;
...
type textareaElement = {
  ...
  cols: (
    val: DomTypeMap[`{"type":"integer","gt":0}`]
  ) => HTMLElement<"textarea">;
...
type trackElement = {
  ...
  kind: (
    val: "subtitles" | "captions" | "descriptions" | "chapters" | "metadata"
  ) => HTMLElement<"track">;
...
type videoElement = {
  ...
  controlslist: (
    val: DomTypeMap[`{"token":{"enum":["nodownload","nofullscreen","noremoteplayback"]},"ordered":false,"caseInsensitive":true,"unique":true,"separator":"space"}`]
  ) => HTMLElement<"video">;
